    ...
    <div className="flex flex-col items-center gap-10 mt-20">
      ...
      <div className="relative flex flex-col items-center justify-center">
        {hablando && (
          ...
          >
            🦉 Recuerda que puedes elegir:<br />
              • Entre <strong>1 a 10 variables</strong><br />
              • Entre <strong>1 a 20 restricciones</strong>
        </motion.div>
)}
      ...
      >
        <div>
          <label className="block text-gray-700 font-semibold mb-1">Número de variables</label>
          <input
            type="number"
            min="1"
            max="10"
        ...
        <div>
          <label className="block text-gray-700 font-semibold mb-1">Número de restricciones</label>
          <input
            type="number"
            min="1"
            max="20"
